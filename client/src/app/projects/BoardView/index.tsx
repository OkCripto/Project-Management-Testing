  ...
  const PriorityTag = ({ priority }: { priority: TaskType["priority"] }) => (
    ...
    >
        {task.attachments && task.attachments.length > 0 && (
            <Image
                src={`https://pm-s3-images-bucket.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
                        ...
                        {task.assignee && (
                            <Image
                                key={task.assignee.userId}
                                    src={`https://pm-s3-images-bucket.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
                        ...
                        {task.author && (
                            <Image
                                key={task.author.userId}
                                    src={`https://pm-s3-images-bucket.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
