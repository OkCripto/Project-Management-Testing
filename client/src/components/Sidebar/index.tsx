...
const Sidebar = () => {
    ...
    const sidebarClassNames = `fixed flex flex-col h-[100%] justify-between shadow-xl
        tansition-all duration-300 h-full z-40 dark:bg-black overflow-y-auto -bg-white 
        w${isSidebarCollapsed ? "w-0 hidden" : "w-64"} `;
  ...
  return  <div className={sidebarClassNames}>
    <div className='flex h-[100%] w-full flex-col justify-start'>  
        ...
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
            <Image src='https://pm-s3-images-bucket.s3.us-east-1.amazonaws.com/logo.png' alt='logo' width={40} height={40} />
            <div>
